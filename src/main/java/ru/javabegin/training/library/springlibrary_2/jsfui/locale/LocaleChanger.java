package ru.javabegin.training.library.springlibrary_2.jsfui.locale;

import ru.javabegin.training.library.springlibrary_2.jsfui.util.CookieHelper;
...
public class LocaleChanger implements Serializable {
    ...
    // хранится текущая выбранная пользователем локаль на уровне его сессии
