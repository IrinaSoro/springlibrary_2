package ru.javabegin.training.library.springlibrary_2.jsfui.util;
...
@Log
@Aspect // спец класс, который отображает текст ошибок или успешной операции (всплывающее сообщение)
@Component
public class AspectMessageHandler {


    // не нужно перехватывать все ошибки в коде, AOP все сделает за нас
    @Around("execution(* ru.javabegin.training.library.springlibrary_2.jsfui.controller.*.deleteAction(..))")
// перехватывать все ошибки во всех методах подпакетов и классов
    ...
    @Around("execution(* ru.javabegin.training.library.springlibrary_2.dao.*.save(..))")
