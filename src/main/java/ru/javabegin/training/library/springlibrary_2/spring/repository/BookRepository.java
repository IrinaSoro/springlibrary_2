...
public interface BookRepository extends JpaRepository<Book, Long> {
    ...
    @Query("select  new ru.javabegin.training.library.springlibrary_2.domain.Book(b.id, b.image) from Book b")
    List<Book> findTopBooks(Pageable pageable);

    //поиск книг по жанру
    @Query("select new ru.javabegin.training.library.springlibrary_2.domain.Book(b.id, b.name, b.pageCount, b.isbn, b.genre, b.author, b.publisher, b.publishYear, b.image, b.descr, b.viewCount, b.totalRating, b.totalVoteCount, b.avgRating) from Book b where b.genre.id=:genreId")
